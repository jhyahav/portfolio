...
export const getCurrentTechPosition = () => new Vector3(-50, -120, 50);
export const getFutureTechPosition = () => new Vector3(210, 0, 0);
export const getTeaPosition = () => new Vector3(210, 0, 0);
